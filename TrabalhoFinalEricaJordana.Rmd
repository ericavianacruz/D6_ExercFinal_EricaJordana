...
consumidorgov1 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2015_1.csv",head=TRUE, sep = ";")
consumidorgov2 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2015_2.csv",head=TRUE, sep = ";")
consumidorgov3 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2016_1.csv",head=TRUE, sep = ";")
consumidorgov4 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2016_2.csv",head=TRUE, sep = ";")
consumidorgov5 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2017_1.csv",head=TRUE, sep = ";")
consumidorgov6 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2017_2.csv",head=TRUE, sep = ";")
consumidorgov181 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-01.csv",head=TRUE, sep = ";")
consumidorgov182 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-02.csv",head=TRUE, sep = ";")
consumidorgov183 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-03.csv",head=TRUE, sep = ";")
consumidorgov184 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-04.csv",head=TRUE, sep = ";")
consumidorgov185 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-05.csv",head=TRUE, sep = ";")
consumidorgov186 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-06.csv",head=TRUE, sep = ";")
consumidorgov187 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-07.csv",head=TRUE, sep = ";")
consumidorgov188 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-08.csv",head=TRUE, sep = ";")
consumidorgov189 <- read.csv ("D:/ENAP_Especializacao/D6_ExercFinal_EricaJordana/dados_brutos/2018-09.csv",head=TRUE, sep = ";")
...
```{r}
consumidoraereo %>% ggplot (aes (x = ano, colour = as.character(ano), fill = ano)) +
  theme_minimal() +
  geom_bar(stat = 'count') + 
  labs(title = "Quantidade de Reclamações por Ano") +
...
ggplot (data = empresas_ano_principais, aes (x= "", y = Quantidade_Reclamacoes , fill = Avaliacao_Reclamacao)) +
    labs(title = "Avaliaçao das Reclamações") +
    geom_bar (stat = "identity") +
    coord_polar("y", start = 0) +
    theme_minimal() +
